...
class secondThread(QThread):
    ...
    def __init__(self, input_id, input_pw, input_keyword, input_add, input_board, input_speed_n, input_like, input_comment, input_add_comment, input_speed_like, input_secret):
        super().__init__()
    ...
    def run(self):
        ...
        self.neighbor_add(self.input_keyword, self.input_add, self.input_board, self.input_speed_n, self.input_like, self.input_comment, self.input_add_comment, self.input_speed_like, self.input_id, self.input_secret)


# 이웃수, 공감, 댓글 싸그리
    def neighbor_add(self, input_keyword, n, input_board, input_speed_n, input_like, input_comment, input_add_comment, input_speed_like, input_id, input_secret):
                ...
                while avg < cnt:
                    ...
                    try:
                        ...
                        if comment_index < input_add_comment:
                            ...
                            if input_secret == 1:
                                print("비밀댓글 들어옴")
                                self.driver.find_element(By.CSS_SELECTOR, "#naverComment__write_textarea_secret_check").click()
...
class second(QDialog):
    def __init__(self):
        ...
        # 이전 세팅값 불러오기
        settings = QSettings("블로그1", "서이추프로그램")
    ...
    def main(self):
        ...
        self.second_thread = secondThread(input_id, input_pw, input_keyword, input_add, input_board, input_speed_n, input_like, input_comment, input_add_comment, input_speed_like, secret)
